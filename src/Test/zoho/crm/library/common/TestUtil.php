...
namespace Jobs\ZohoSDK\Test\zoho\crm\library\common;

use Jobs\ZohoSDK\Test\zoho\crm\library\api\MetaDataAPIHandlerTest;

class TestUtil
{
    public static $sampleDate=null;
    public static $sampleDateTimeISO=null;
    public static $dataTypeVsValue=['integer'=>456789,'text'=>'SampleData','double'=>100435,'phone'=>'9999000000',
        'email'=>'sumanth.chilka+automation@zohocorp.com',
        'website'=>'www.zohocorp.com',
        'bigint'=>'9876543210123456',
        'boolean'=>true
    ];
    public static $nonSupportiveModules=['Approvals','Activities','CustomModule5001','CustomModule5002','CustomModule5003','CustomModule5004','CustomModule5005','CustomModule5006','CustomModule5007','CustomModule5008'];
    ...
    public static function moveModulePositions($isToFront, $moduleNames, $moduleList)
    {
        foreach ($moduleNames as $moduleName) {
            ...
            if ($isToFront) {
                $moduleList=[$moduleAPIName=>$moduleName]+$moduleList;
            } else {
                $moduleList=$moduleList+[$moduleAPIName=>$moduleName];
            }
        }
        return $moduleList;
    }
    ...
    {
        return in_array($moduleName, ['Tasks','Calls','Events']);
    }
}
