...
namespace Jobs\ZohoSDK\Test\zoho\crm\library;

use Exception;
use Jobs\ZohoSDK\com\zoho\crm\library\setup\restclient\ZCRMRestClient;
use Jobs\ZohoSDK\Test\zoho\crm\library\api\EntityAPIHandlerTest;
use Jobs\ZohoSDK\Test\zoho\crm\library\api\MassEntityAPIHandlerTest;
use Jobs\ZohoSDK\Test\zoho\crm\library\api\MetaDataAPIHandlerTest;
use Jobs\ZohoSDK\Test\zoho\crm\library\api\ModuleAPIHandlerTest;
use Jobs\ZohoSDK\Test\zoho\crm\library\api\OrganizationAPIHandlerTest;
...
class Main
{
    ...
    public function sendMailWithAuthentication($file)
    {
        ...
        $smtp = Mail::factory('smtp', ['host' => $host, 'auth' => true,
