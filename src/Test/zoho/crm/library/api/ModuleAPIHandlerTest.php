...
class ModuleAPIHandlerTest
{
    ...
    public static $moduleVsLayoutIdMap=[];
    public static $moduleVsCustomViewIdMap=[];
                ...
                try {
                    ...
                    if (!TestUtil::isActivityModule($moduleName) && $moduleName!='Activities' && $moduleName!='Attachments') {
                        ...
                        if ($dataType=='lookup' && $zcrmField->getLookupField()==null) {
                            ...
                            continue;
                        } elseif ($dataType=='picklist' && $zcrmField->getPickListFieldValues()==null) {
                            ...
                            continue;
                        } elseif ($dataType=='currency' && ($zcrmField->getPrecision()==null || $zcrmField->getDecimalPlace()==null || $zcrmField->getRoundingOption()==null)) {
            ...
            try {
                ...
                foreach ($zcrmLayouts as $zcrmLayout) {
                    ...
                    if (sizeof($convertMapping)>0) {
                        ...
                        } elseif (!is_string($dealMapIns->getName()) || !is_long($dealMapIns->getId())) {
                            throw new ZCRMException('Lead convert mapping for Deals not fetched properly');
                        } elseif (!is_string($conMapIns->getName()) || !is_long($conMapIns->getId())) {
        ...
        foreach (MetaDataAPIHandlerTest::$moduleList as $moduleApiName=>$moduleName) {
            ...
            try {
                ...
                foreach ($zcrmCustomViews as $zcrmCustomView) {
                    ...
                    } elseif (!TestUtil::isActivityModule($moduleName) && ($zcrmCustomView->getFields()==null || !(sizeof($zcrmCustomView->getFields())>=1))) {
