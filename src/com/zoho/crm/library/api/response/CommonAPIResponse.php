...
class CommonAPIResponse
{
    ...
    public function processResponse()
    {
        ...
        } elseif ($this->httpStatusCode == APIConstants::RESPONSECODE_ACCEPTED || $this->httpStatusCode == APIConstants::RESPONSECODE_OK || $this->httpStatusCode == APIConstants::RESPONSECODE_CREATED) {
