...
namespace Jobs\ZohoSDK\com\zoho\oauth\clientapp;

use Exception;
use Jobs\ZohoSDK\com\zoho\crm\library\exception\Logger;
use Jobs\ZohoSDK\com\zoho\oauth\client\ZohoOAuth;
use Jobs\ZohoSDK\com\zoho\oauth\client\ZohoOAuthPersistenceInterface;
use Jobs\ZohoSDK\com\zoho\oauth\common\OAuthLogger;
use Jobs\ZohoSDK\com\zoho\oauth\common\ZohoOAuthConstants;
use Jobs\ZohoSDK\com\zoho\oauth\common\ZohoOAuthException;
use Jobs\ZohoSDK\com\zoho\oauth\common\ZohoOAuthTokens;
...
class ZohoOAuthPersistenceHandler implements ZohoOAuthPersistenceInterface
{
    ...
    public function getMysqlConnection()
    {
        $mysqli_con = new mysqli(
            'localhost:'.ZohoOAuth::getConfigValue(ZohoOAuthConstants::DATABASE_PORT),
